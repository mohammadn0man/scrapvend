...
public final class R {
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #AppCompatTextView_drawableLeftCompat com.example.login:drawableLeftCompat}</code></td><td>Compound drawables allowing the use of vector drawable when running on older versions
     ...
     * <tr><td><code>{@link #AppCompatTextView_drawableTint com.example.login:drawableTint}</code></td><td>Tint to apply to the compound (left, top, etc.) drawables.</td></tr>
     * <tr><td><code>{@link #AppCompatTextView_drawableTintMode com.example.login:drawableTintMode}</code></td><td>Blending mode used to apply the compound (left, top, etc.) drawables tint.</td></tr>
     ...
     * <tr><td><code>{@link #AppCompatTextView_fontVariationSettings com.example.login:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     ...
     * <tr><td><code>{@link #AppCompatTextView_textLocale com.example.login:textLocale}</code></td><td>Set the textLocale by a comma-separated language tag string,
     ...
     * <tr><td><code>{@link #AppCompatTheme_listChoiceIndicatorMultipleAnimated com.example.login:listChoiceIndicatorMultipleAnimated}</code></td><td>Animated Drawable to use for single choice indicators.</td></tr>
     * <tr><td><code>{@link #AppCompatTheme_listChoiceIndicatorSingleAnimated com.example.login:listChoiceIndicatorSingleAnimated}</code></td><td>Animated Drawable to use for multiple choice indicators.</td></tr>
     ...
     * <tr><td><code>{@link #AppCompatTheme_listPreferredItemPaddingEnd com.example.login:listPreferredItemPaddingEnd}</code></td><td>The preferred padding along the end edge of list items.</td></tr>
     ...
     * <tr><td><code>{@link #AppCompatTheme_listPreferredItemPaddingStart com.example.login:listPreferredItemPaddingStart}</code></td><td>The preferred padding along the start edge of list items.</td></tr>
     ...
     * <tr><td><code>{@link #CompoundButton_buttonCompat com.example.login:buttonCompat}</code></td><td>Compat attr to load backported drawable types</td></tr>
     ...
     * <tr><td><code>{@link #TextAppearance_fontVariationSettings com.example.login:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #TextAppearance_textAllCaps com.example.login:textAllCaps}</code></td><td>Present the text in ALL CAPS.</td></tr>
     * <tr><td><code>{@link #TextAppearance_textLocale com.example.login:textLocale}</code></td><td>Set the textLocale by a comma-separated language tag string,
     * for example "ja-JP,zh-CN".</td></tr>
     * </table>
     ...
     * <tr><td><code>{@link #Toolbar_menu com.example.login:menu}</code></td><td>Menu resource to inflate to be shown in the toolbar</td></tr>
