...
public class PickupInfoPickupPersonAssigned extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
        ...
        String query;
        final String TAG = "MyPickupinfoPAssigned";
        String[] pickupinfoCategory;

        protected void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            setContentView(R.layout.pickupinfo_assign_pickup_view);
        ...
        private class PickupInfoPersonAssignTask extends AsyncTask<Void,Void,Void> {
